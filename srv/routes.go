...
func (s *Server) routes() *http.ServeMux {
	...
	mux.HandleFunc("GET /api/apps/{slug}/testers", s.requireAPI(s.handleApiGetTesters))
	mux.HandleFunc("GET /api/apps/{slug}/{platform}/testers", s.requireAPI(s.handleApiGetTesters))
