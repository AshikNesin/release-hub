...
SELECT ap.id, ap.app_id, ap.platform, ap.package_name, ap.play_enabled, ap.sign_keystore, ap.sign_config, ap.sign_sha256, ap.created_at, ap.play_account_id, ap.prune_keep FROM app_platforms ap WHERE ap.play_enabled = 1
`
